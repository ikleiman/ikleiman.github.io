(function() {
  ...
  optionalServices: ['11223344-5566-7788-9900-aabbccddeeff']
})
      .then(device => {
        this.device = device;
      ...
      .then(server => {
        this.server = server;
        return Promise.all([
          server.getPrimaryService('11223344-5566-7788-9900-aabbccddeeff').then(service => {
            return Promise.all([
              this._cacheCharacteristic(service, '12345678-9012-3456-7890-123456789011'),
